...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_continued) { described_class.new(5,'10') }
      # remove the 'x' before running this test
      it 'is not game over' do
        expect(game_continued).not_to be_game_over
      end
    end
  end
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        user_input = '10'
        verification = game_check.verify_input(user_input)
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      subject(:game_four) { described_class.new(9, '9', 4) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        "That was hard. It took you #{game_four.count} guesses!\n"
      end
    end
  end
end
